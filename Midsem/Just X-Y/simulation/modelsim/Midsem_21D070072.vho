...
-- output_vector[1]	=>  Location: PIN_21,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- output_vector[2]	=>  Location: PIN_24,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- output_vector[3]	=>  Location: PIN_25,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- input_vector[0]	=>  Location: PIN_140,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- input_vector[4]	=>  Location: PIN_134,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- input_vector[1]	=>  Location: PIN_17,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- input_vector[5]	=>  Location: PIN_141,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- input_vector[2]	=>  Location: PIN_15,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- input_vector[6]	=>  Location: PIN_130,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- input_vector[7]	=>  Location: PIN_135,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- input_vector[3]	=>  Location: PIN_22,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
SIGNAL \flag_instance|Adder1|FA0|half1|xor1|Y~combout\ : std_logic;
SIGNAL \input_vector[1]~input_o\ : std_logic;
SIGNAL \input_vector[5]~input_o\ : std_logic;
SIGNAL \flag_instance|Adder2|FA1|half2|xor1|Y~0_combout\ : std_logic;
SIGNAL \flag_instance|Adder2|FA1|half2|and1|Y~combout\ : std_logic;
...
SIGNAL \flag_instance|Adder2|FA2|half2|xor1|Y~combout\ : std_logic;
...
SIGNAL \flag_instance|Adder2|FA3|half2|xor1|Y~1_combout\ : std_logic;
...
-- pragma translate_on
PORT MAP (
	i => \flag_instance|Adder1|FA0|half1|xor1|Y~combout\,
	devoe => ww_devoe,
...
-- pragma translate_on
PORT MAP (
	i => \flag_instance|Adder2|FA1|half2|xor1|Y~0_combout\,
	devoe => ww_devoe,
...
-- pragma translate_on
PORT MAP (
	i => \flag_instance|Adder2|FA2|half2|xor1|Y~combout\,
	devoe => ww_devoe,
...
\flag_instance|Adder1|FA0|half1|xor1|Y\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \flag_instance|Adder1|FA0|half1|xor1|Y~combout\ = \input_vector[0]~input_o\ $ (\input_vector[4]~input_o\)
...
PORT MAP (
	...
	combout => \flag_instance|Adder1|FA0|half1|xor1|Y~combout\);
...
\flag_instance|Adder2|FA1|half2|xor1|Y~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \flag_instance|Adder2|FA1|half2|xor1|Y~0_combout\ = \input_vector[1]~input_o\ $ (\input_vector[5]~input_o\ $ (((\input_vector[0]~input_o\ & !\input_vector[4]~input_o\))))
...
PORT MAP (
	...
	combout => \flag_instance|Adder2|FA1|half2|xor1|Y~0_combout\);

-- Location: LCCOMB_X7_Y19_N12
\flag_instance|Adder2|FA1|half2|and1|Y\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \flag_instance|Adder2|FA1|half2|and1|Y~combout\ = (\input_vector[1]~input_o\ & ((\input_vector[0]~input_o\ $ (\input_vector[4]~input_o\)) # (!\input_vector[5]~input_o\))) # (!\input_vector[1]~input_o\ & ((\input_vector[5]~input_o\) # 
...
PORT MAP (
	...
	datac => \input_vector[4]~input_o\,
	datad => \input_vector[5]~input_o\,
	combout => \flag_instance|Adder2|FA1|half2|and1|Y~combout\);
...
-- Equation(s):
-- \flag_instance|Adder0|FA1|half2|and1|Y~combout\ = (\input_vector[5]~input_o\) # (\input_vector[4]~input_o\)
...
-- Equation(s):
-- \flag_instance|Adder1|FA2|half2|xor1|Y~combout\ = \flag_instance|Adder1|FA1|or1|Y~0_combout\ $ (\flag_instance|Adder0|FA1|half2|and1|Y~combout\ $ (\input_vector[2]~input_o\ $ (\input_vector[6]~input_o\)))
...
\flag_instance|Adder2|FA2|half2|xor1|Y\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \flag_instance|Adder2|FA2|half2|xor1|Y~combout\ = \flag_instance|Adder2|FA1|half2|and1|Y~combout\ $ (\flag_instance|Adder1|FA2|half2|xor1|Y~combout\)
...
-- pragma translate_on
PORT MAP (
	dataa => \flag_instance|Adder2|FA1|half2|and1|Y~combout\,
	datac => \flag_instance|Adder1|FA2|half2|xor1|Y~combout\,
	combout => \flag_instance|Adder2|FA2|half2|xor1|Y~combout\);
...
-- Equation(s):
-- \flag_instance|Adder2|FA3|half2|xor1|Y~0_combout\ = \flag_instance|Adder1|FA2|or1|Y~0_combout\ $ (\input_vector[7]~input_o\)
...
\flag_instance|Adder2|FA3|half2|xor1|Y~1\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \flag_instance|Adder2|FA3|half2|xor1|Y~1_combout\ = \input_vector[3]~input_o\ $ (((\input_vector[4]~input_o\) # ((\input_vector[5]~input_o\) # (\input_vector[6]~input_o\))))
...
PORT MAP (
	...
	datad => \input_vector[6]~input_o\,
	combout => \flag_instance|Adder2|FA3|half2|xor1|Y~1_combout\);

-- Location: LCCOMB_X7_Y19_N4
\flag_instance|Adder2|FA3|half2|xor1|Y\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \flag_instance|Adder2|FA3|half2|xor1|Y~combout\ = \flag_instance|Adder2|FA3|half2|xor1|Y~0_combout\ $ (\flag_instance|Adder2|FA3|half2|xor1|Y~1_combout\ $ (((\flag_instance|Adder2|FA1|half2|and1|Y~combout\) # 
-- (\flag_instance|Adder1|FA2|half2|xor1|Y~combout\))))
...
PORT MAP (
	dataa => \flag_instance|Adder2|FA1|half2|and1|Y~combout\,
	datab => \flag_instance|Adder2|FA3|half2|xor1|Y~0_combout\,
	datac => \flag_instance|Adder1|FA2|half2|xor1|Y~combout\,
	datad => \flag_instance|Adder2|FA3|half2|xor1|Y~1_combout\,
