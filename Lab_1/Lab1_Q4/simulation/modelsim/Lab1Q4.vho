...
-- output_vector[1]	=>  Location: PIN_133,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- input_vector[1]	=>  Location: PIN_132,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- input_vector[0]	=>  Location: PIN_131,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- input_vector[2]	=>  Location: PIN_129,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
SIGNAL \add_instance|NAND9|Y~0_combout\ : std_logic;
SIGNAL \add_instance|NAND8|Y~0_combout\ : std_logic;
...
-- pragma translate_on
PORT MAP (
	i => \add_instance|NAND9|Y~0_combout\,
	devoe => ww_devoe,
...
-- pragma translate_on
PORT MAP (
	i => \add_instance|NAND8|Y~0_combout\,
	devoe => ww_devoe,
...
\add_instance|NAND9|Y~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \add_instance|NAND9|Y~0_combout\ = (\input_vector[0]~input_o\ & ((\input_vector[1]~input_o\) # (!\input_vector[2]~input_o\))) # (!\input_vector[0]~input_o\ & (!\input_vector[2]~input_o\ & \input_vector[1]~input_o\))
...
PORT MAP (
	...
	combout => \add_instance|NAND9|Y~0_combout\);

-- Location: LCCOMB_X25_Y38_N26
\add_instance|NAND8|Y~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \add_instance|NAND8|Y~0_combout\ = \input_vector[0]~input_o\ $ (\input_vector[2]~input_o\ $ (\input_vector[1]~input_o\))
...
PORT MAP (
	...
	datac => \input_vector[2]~input_o\,
	datad => \input_vector[1]~input_o\,
	combout => \add_instance|NAND8|Y~0_combout\);
