...
-- Design Ports Information
-- output_vector[0]	=>  Location: PIN_20,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- input_vector[0]	=>  Location: PIN_23,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- input_vector[1]	=>  Location: PIN_22,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
SIGNAL \add_instance|NAND5|Y~0_combout\ : std_logic;
SIGNAL \add_instance|NAND5|ALT_INV_Y~0_combout\ : std_logic;
...
\add_instance|NAND5|ALT_INV_Y~0_combout\ <= NOT \add_instance|NAND5|Y~0_combout\;
...
-- pragma translate_on
PORT MAP (
	i => \add_instance|NAND5|ALT_INV_Y~0_combout\,
	devoe => ww_devoe,
...
\add_instance|NAND5|Y~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \add_instance|NAND5|Y~0_combout\ = \input_vector[1]~input_o\ $ (\input_vector[0]~input_o\)
...
PORT MAP (
	...
	combout => \add_instance|NAND5|Y~0_combout\);
