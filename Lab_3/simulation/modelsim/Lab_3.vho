...
-- input_vector[0]	=>  Location: PIN_43,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- input_vector[2]	=>  Location: PIN_39,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- input_vector[3]	=>  Location: PIN_38,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- input_vector[1]	=>  Location: PIN_41,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
SIGNAL \add_instance|OR_fin|Y~0_combout\ : std_logic;
...
-- pragma translate_on
PORT MAP (
	i => \add_instance|OR_fin|Y~0_combout\,
	devoe => ww_devoe,
...
\add_instance|OR_fin|Y~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \add_instance|OR_fin|Y~0_combout\ = (\input_vector[2]~input_o\ & (!\input_vector[1]~input_o\ & ((\input_vector[0]~input_o\)))) # (!\input_vector[2]~input_o\ & (((!\input_vector[1]~input_o\ & !\input_vector[0]~input_o\)) # (!\input_vector[3]~input_o\)))

-- pragma translate_off
GENERIC MAP (
	lut_mask => "0101000000110111",
	sum_lutc_input => "datac")
-- pragma translate_on
PORT MAP (
	...
	combout => \add_instance|OR_fin|Y~0_combout\);
