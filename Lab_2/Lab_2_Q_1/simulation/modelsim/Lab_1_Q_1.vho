...
-- output_vector[1]	=>  Location: PIN_135,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
SIGNAL \add_instance|AND2|Y~combout\ : std_logic;
...
-- Equation(s):
-- \add_instance|AND1|Y~combout\ = (!\input_vector[1]~input_o\ & \input_vector[0]~input_o\)
...
\add_instance|AND2|Y\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \add_instance|AND2|Y~combout\ = (\input_vector[1]~input_o\ & \input_vector[0]~input_o\)
...
PORT MAP (
	datab => \input_vector[1]~input_o\,
	datac => \input_vector[0]~input_o\,
	combout => \add_instance|AND2|Y~combout\);
